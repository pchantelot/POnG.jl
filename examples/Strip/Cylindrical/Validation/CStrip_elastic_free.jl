...
B0l = C[3,udof,udof,2] ⊗ (I(P) ⊗ D2)[left,:] .+  C[3,udof,udof,3] ⊗ (D3 ⊗ Diagonal(1 ./ x2))[left,:] .+  C[3,udof,udof,3]*A ⊗ (I(P) ⊗ Diagonal(1 ./ x2))[left,:]
# zero displacement right
Bkr =  C[3,udof,udof,1] ⊗ I(N*P)[right,:]
B0r = C[3,udof,udof,2] ⊗ (I(P) ⊗ D2)[right,:] .+ C[3,udof,udof,3] ⊗ (D3 ⊗ Diagonal(1 ./ x2))[right,:] .+ C[3,udof,udof,3]*A ⊗ (I(P) ⊗ Diagonal(1 ./ x2))[right,:]
