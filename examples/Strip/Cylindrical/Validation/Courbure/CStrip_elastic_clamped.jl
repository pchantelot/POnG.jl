...
N = 7 # number of nodes in direction 2, must be even for in-plane modes and odd for out-of-plane modes
...
ksave = kplot[idxplot .== 2]
fsave = fplot[idxplot .== 2]
resultfilt = result2D(udof,N,P,fsave,ksave,[NaN])
save(joinpath(@__DIR__,"R1000.jld2"),"k",ksave,"ω",fsave)
